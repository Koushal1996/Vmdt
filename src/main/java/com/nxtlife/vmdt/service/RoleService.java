...
public interface RoleService {
     ...
     * @throws NotFoundException if organization id not found
     */
     ...
     * @throws NotFoundException   if role id isn't correct
     * @throws ValidationException if authority ids aren't correct or if updated role name is
     ...
     * @return {@link SuccessResponse} if user deleted successfully
     * @throws NotFoundException   if role not found
     * @throws ValidationException if some of the users are assigned with this role or role name
     *                             is superadmin
     */

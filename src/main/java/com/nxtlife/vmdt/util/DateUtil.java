...
public class DateUtil {
    ...
    public static final String seasonPlanDateFormat = "MM-dd";
    ...
    public static String getSeasonPlanDate(long time) {
        DateFormat df = new SimpleDateFormat(seasonPlanDateFormat);
        df.setLenient(false);
        return df.format(new Date(time));
    }

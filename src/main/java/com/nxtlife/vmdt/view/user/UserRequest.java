...
import com.nxtlife.vmdt.view.Request;
...
public class UserRequest implements Request {
	...
	@Schema(description = "Mobile No of the user", example = "1234567890")
	@Size(min = 10, max = 10)
	@Pattern(regexp = "^[0-9]*$", message = "Mobile no should contain only digit")
	private String mobileNo;

	@Schema(description = "User contact number", example = "0114592-01")
